...
definitions = {'definitions': {'new_recipe_details': {'required': ['name', 'steps', 'classification', 'nutirtional_information', 'image', 'ingredients'], 'properties': {'name': {'type': 'string', 'example': 'sandwich'}, 'steps': {'type': 'string', 'example': 'step1,step2, there you go!'}, 'classification': {'type': 'string', 'enum': ['Breakfast', 'Brunch', 'Snack', 'Lunch', 'Tea', 'Supper', 'Dinner']}, 'nutirtional_information': {'type': 'string', 'example': 'some string'}, 'image': {'type': 'string', 'example': 'link to image'}, 'ingredients': {'type': 'array', 'items': {'$ref': '#/definitions/ingredients'}}}, 'type': 'object'}, 'recipe_details': {'properties': {'id': {'type': 'integer', 'example': 101}, 'uuid': {'type': 'string', 'example': '21321j3123j-3n123-3123'}, 'image': {'type': 'string'}, 'name': {'type': 'string', 'example': 'sandwich'}, 'ingredients': {'type': 'array', 'items': {'type': 'string'}, 'example': [{'name': 'bread', 'image': 'image_link'}]}, 'steps': {'type': 'string', 'example': 'take bread make sandwich'}, 'classification': {'type': 'string', 'example': 'Breakfast'}, 'nutirtional_information': {'type': 'string', 'example': 'some string'}}, 'type': 'object'}, 'ingredients': {'type': 'object', 'properties': {'name': {'type': 'string', 'example': 'bread'}, 'image': {'type': 'string', 'example': 'link_image'}}}, 'login_details': {'required': ['password', 'username'], 'properties': {'username': {'type': 'string', 'example': 'mohitkhanna'}, 'password': {'type': 'string', 'example': 'khanna1234'}}, 'type': 'object'}, 'token_details': {'properties': {'token': {'type': 'string'}}, 'type': 'object'}, 'review_details': {'properties': {'id': {'type': 'integer', 'example': 101}, 'uuid': {'type': 'string', 'example': '21321j3123j-3n123-3123'}, 'ratings': {'type': 'integer', 'example': 4}, 'comments': {'type': 'string', 'example': 'tasty!'}, 'menu_id': {'type': 'string', 'example': '21312321-4221-fefe-11'}, 'recipe_id': {'type': 'string', 'example': 'dadfsd1221-4221-fefe-11'}, 'customer_id': {'type': 'string', 'example': 'dadfsd1221-4221-fefe-11'}}, 'type': 'object'}, 'review_details_body': {'properties': {'ratings': {'type': 'integer', 'example': 4}, 'comments': {'type': 'string', 'example': 'tasty!'}, 'menu_id': {'type': 'string', 'example': '21312321-4221-fefe-11'}, 'recipe_id': {'type': 'string', 'example': 'dadfsd1221-4221-fefe-11'}, 'customer_id': {'type': 'string', 'example': 'dadfsd1221-4221-fefe-11'}}, 'type': 'object'}, 'message': {'type': 'object', 'properties': {'message': {'type': 'string', 'example': 'Success/Error message'}}}, 'signup_details': {'required': ['password', 'username'], 'properties': {'username': {'type': 'string', 'example': 'mohitkhanna'}, 'password': {'type': 'string', 'example': 'khanna1234'}}, 'type': 'object'}}, 'parameters': {}}
...
filters = {
    ...
    ('menu', 'POST'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/review_details'}}, 400: {'headers': None, 'schema': None}, 403: {'headers': None, 'schema': None}},
    ...
    ('review', 'POST'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/review_details'}}, 400: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}, 403: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}},
