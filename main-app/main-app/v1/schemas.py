...
filters = {
    ...
    ('recipe', 'POST'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/recipe_details'}}, 400: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}, 403: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}},
