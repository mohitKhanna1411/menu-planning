...
definitions = {'definitions': {'new_recipe_details': {'required': ['name', 'steps', 'classification', 'nutirtional_information', 'image'], 'properties': {'name': {'type': 'string', 'example': 'aloo paranthe'}, 'method': {'type': 'string', 'example': 'step1,step2, there you go!'}, 'classification': {'type': 'string', 'enum': ['Breakfast', 'Brunch', 'Snack', 'Lunch', 'Tea', 'Supper', 'Dinner']}, 'nutirtional_information': {'type': 'string', 'example': 'some string'}, 'image': {'type': 'string', 'example': 'link to image'}}, 'type': 'object'}, 'recipe_details': {'properties': {'id': {'type': 'integer', 'example': 101}, 'uuid': {'type': 'string', 'example': '21321j3123j-3n123-3123'}, 'image': {'type': 'string'}, 'name': {'type': 'string', 'example': 'sandwich'}, 'ingredients': {'type': 'array', 'items': {'type': 'string'}, 'example': ['101-dasfda-dasdfad', '201-nfsnfnjk-fdasfa']}, 'steps': {'type': 'string', 'example': 'take bread make sandwich'}, 'classification': {'type': 'string', 'example': 'Breakfast'}, 'nutirtional_information': {'type': 'string', 'example': 'some string'}}, 'type': 'object'}, 'recipe_id_details': {'properties': {'recipe_id': {'type': 'string'}}, 'type': 'object'}, 'ingredientsBody': {'type': 'object', 'properties': {'name': {'type': 'string', 'example': 'bread'}, 'image': {'type': 'string', 'example': 'link_image'}}}, 'ingredients': {'type': 'object', 'properties': {'id': {'type': 'integer', 'example': 1}, 'uuid': {'type': 'string', 'example': '213213-23123-dsfsdf-1212'}, 'name': {'type': 'string', 'example': 'bread'}, 'image': {'type': 'string', 'example': 'link_image'}}}, 'login_details': {'required': ['password', 'username'], 'properties': {'username': {'type': 'string', 'example': 'mohitkhanna'}, 'password': {'type': 'string', 'example': 'khanna1234'}}, 'type': 'object'}, 'token_details': {'properties': {'token': {'type': 'string'}}, 'type': 'object'}, 'message': {'type': 'object', 'properties': {'message': {'type': 'string', 'example': 'Success/Error message'}}}, 'signup_details': {'required': ['password', 'username'], 'properties': {'username': {'type': 'string', 'example': 'mohitkhanna'}, 'password': {'type': 'string', 'example': 'khanna1234'}}, 'type': 'object'}}, 'parameters': {}}
...
validators = {
    ...
    ('ingredients', 'POST'): {'json': {'$ref': '#/definitions/ingredientsBody'}, 'headers': {'required': [], 'properties': {'Authorization': {'type': 'string', 'description': "Your Authorization Token in the form 'Token <AUTH_TOKEN>'"}}}},
    ('ingredients', 'PUT'): {'json': {'$ref': '#/definitions/ingredientsBody'}, 'headers': {'required': [], 'properties': {'Authorization': {'type': 'string', 'description': "Your Authorization Token in the form 'Token <AUTH_TOKEN>'"}}}, 'args': {'required': [], 'properties': {'uuid': {'description': 'the uuid of the ingredient to update', 'type': 'string'}}}},
    ('ingredients_list', 'GET'): {'headers': {'required': [], 'properties': {'Authorization': {'type': 'string', 'description': "Your Authorization Token in the form 'Token <AUTH_TOKEN>'"}}}},
...
filters = {
    ...
    ('auth_signup', 'POST'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/token_details'}}, 400: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}, 409: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}},
    ...
    ('recipe', 'POST'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/recipe_id_details'}}, 400: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}, 403: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}},
    ...
    ('ingredients', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/ingredients'}}, 400: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}, 403: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}, 404: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}},
    ('ingredients', 'POST'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}, 400: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}, 403: {'headers': None, 'schema': {'$ref': '#/definitions/message'}}},
    ...
    ('ingredients_list', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/ingredients'}}}, 400: {'headers': None, 'schema': None}, 403: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
